...
| [Kronikol](https://github.com/lemonlion/Kronikol) | - Generates rich interactive HTML reports with PlantUML sequence, activity and component diagrams, with timeline visualizations from your integration/component test HTTP traffic (real or faked) and telemetry<br>- Previously known as TestTrackingDiagrams

...
| [TestTrackingDiagrams](https://github.com/lemonlion/TestTrackingDiagrams) | Auto-generates PlantUML/Mermaid sequence diagrams from integration and component tests by tracking HTTP traffic between services. Supports xUnit2/3, NUnit4, MSTest, LightBDD, BDDfy, ReqNRoll. Produces searchable HTML reports with embedded diagrams and YAML specs.
